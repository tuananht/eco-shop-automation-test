...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 4-Click on link shop2 - Navigate to page shop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 5-Hover over div herringbonePineTreeIndoorPlants.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 6-Click on button addToBasket.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 7-Click on button checkOut.png')
...
WebUI.takeScreenshot(reportLocation + '/TC6/Step 8-Click on span closeButton.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Add to Basket and Checkout with Stone Lotus_visual_checkpoint')
