...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 3: Hover over div productDisplay.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 4: Click on image productCardImg - Navigate to page product.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 5: Click on button addToBasket.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 6: Click on button addToBasket.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 7: Click on span navigationButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 8: Click on input fullName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 9: Click on button signInToCheckout - Navigate to page signin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 10: Click on button signUp - Navigate to page signup.png')

"Step 11: Click on button signIn -> Navigate to page ''"
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 11: Click on button signIn - Navigate to page .png')

"Step 12: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Verify Checkout Process with Sign in and Search_visual_checkpoint')
