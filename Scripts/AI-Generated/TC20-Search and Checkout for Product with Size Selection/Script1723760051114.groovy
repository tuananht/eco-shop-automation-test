...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 2-Click on link signIn - Navigate to page signin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 4-Hover over div productDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 5-Click on header productName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC20/Step 6-Enter input value in input searchProduct.png')

"Step 7: Select item size and proceed to checkout"

selectSizeAndProceedToCheckout.execute()

"Step 8: Complete shipping and payment information for order"

completeShippingAndPaymentInformation.execute(data_path_0, Integer.valueOf(index_0))

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC20-Search and Checkout for Product with Size Selection_visual_checkpoint')
