...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 4: Hover over div productDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 5: Enter input value in input searchProduct.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 6: Click on button addToBasket.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 7: Click on span navigationButton.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 8: Click on input fullName.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify Searching and Adding Product to Basket_visual_checkpoint')
