...
import katalon.common.selectSizeAndAddToBasket
...
"Step 7: Select item size and add it to the shopping basket"

selectSizeAndAddToBasket.execute()

"Step 8: Fill in shipping information and confirm payment details"

completeCheckoutWithShippingDetails.execute(data_path_0, Integer.valueOf(index_0))

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Select and Purchase Indoor Plant with Size Option_visual_checkpoint')
