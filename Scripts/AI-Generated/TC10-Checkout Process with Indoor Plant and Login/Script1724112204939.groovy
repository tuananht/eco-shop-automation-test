...
import katalon.common.completeCheckoutWithShippingDetails
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 2-Click on link shop2 - Navigate to page shop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 3-Hover over div herringbonePineTreeIndoorPlants.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 4-Click on button addToBasket.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 5-Click on button checkOut.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 6-Click on input fullName.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 7-Click on button signInToCheckout - Navigate to page signin.png')

"Step 8: Login into Application"

TrueTestScripts.login()

"Step 9: Select indoor plant and proceed to checkout with details"

addIndoorPlantToBasketAndCheckout.execute()

"Step 10: Fill in shipping information and confirm payment details"

completeCheckoutWithShippingDetails.execute(data_path_0, Integer.valueOf(index_0))

"Step 11: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Checkout Process with Indoor Plant and Login_visual_checkpoint')
