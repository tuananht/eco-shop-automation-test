...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 2-Click on link signIn - Navigate to page signin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 4-Hover over div productDetails.png')
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 5-Enter input value in input searchProduct.png')
...
WebUI.takeScreenshot(reportLocation + '/TC12/Step 6-Click on header productName.png')
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC12-Select Size and Checkout for Searched Product_visual_checkpoint')
