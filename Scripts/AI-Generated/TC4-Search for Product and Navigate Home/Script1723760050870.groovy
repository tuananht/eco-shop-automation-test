...
"Step 4: Enter input value in input searchProduct -> Navigate to page 'search/test'"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/shop?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.setText(findTestObject('AI-Generated/Page_shop/input_searchProduct'), var_1_input_searchProduct)

WebUI.takeScreenshot(reportLocation + '/TC4/Step 4-Enter input value in input searchProduct - Navigate to page searchtest.png')

"Step 5: Click on input searchProduct"

// WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/search/test?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_search_test/input_searchProduct'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_search_test/link_featured'))

WebUI.takeScreenshot(reportLocation + '/TC4/Step 6-Click on link featured - Navigate to page .png')

"Step 7: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC4-Search for Product and Navigate Home_visual_checkpoint')
