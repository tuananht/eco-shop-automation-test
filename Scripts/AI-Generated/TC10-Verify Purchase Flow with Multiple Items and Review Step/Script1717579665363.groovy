...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 2: Click on link Sign In - Navigate to page signin.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 5: Hover over div.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 6: Click on button Add to basket.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 7: Click on span.png')
...
WebUI.takeScreenshot(reportLocation + '/TC10/Step 8: Click on div.png')

"Step 9: Select items, review order, and proceed to checkout"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC10-Verify Purchase Flow with Multiple Items and Review Step_visual_checkpoint')
