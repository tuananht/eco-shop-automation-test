...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 2: Click on link Shop - Navigate to page shop.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 3: Hover over div.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 4: Click on button Add to basket.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 5: Click on span.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 6: Click on button CHECK OUT.png')
...
WebUI.takeScreenshot(reportLocation + '/TC9/Step 7: Click on button Sign in to checkout - Navigate to page signin.png')

"Step 8: Login into Application"

TrueTestScripts.login()

"Step 9: Browse shop, add item to basket, and checkout"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC9-Verify Checkout Process with Sign In During Checkout_visual_checkpoint')
